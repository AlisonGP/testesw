...
public class TesteCadastroNovaEmpresa {
	 ...
	 @Before
	  ...
	  public void testE() throws Exception {
	    ...
	    //new Select(driver.findElement(By.id("tipoEmpresa"))).selectByValue("1");
	    new Select(driver.findElement(By.id("tipoEmpresa"))).getOptions().get(1).click();
	   
//	    new Select(driver.findElement(By.id("tipoEmpresa"))).selectByIndex(1);
//	    driver.findElement(By.cssSelector("option[value=\"1\"]")).click();
	    ...
	    assertEquals("Operação realizada com sucesso!",driver.findElement(By.cssSelector("ui-messages-info-summary")).getText());
	  }
